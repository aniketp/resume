...
\position{Second Year Undergraduate{\enskip\cdotp\enskip}Mathematics and Scientific Computing} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A
%quote or statement

\makecvfooter{\today}{Aniket Pandey~~~·~~~Résumé}{\thepage}
