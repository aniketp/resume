...
\location{Summer Research Intern \hfill \textit{Prof. Latifur Khan}}
...
\descript{\hfill \textit{Nov'17 - May'18}}
...
\hspace{-6pt} \begin{tabular*}{\textwidth}{lllll}
 Data Structures and Algorithms & Operating Systems & Computer Networks & Computer Architecture \textit{(s)} & Distributed Systems \textit{(i)} \\
 Computer Systems Security \textit{(i)} & Abstract Algebra & Regression Analysis \textit{(i)} & Probability \& Statistics &  Scientific Computing \textit{(i)}
\end{tabular*}
