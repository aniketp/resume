...
\descript{B.S, \textit{Mathematics and Scientific Computing}\\\textit{Minor in Computer Systems}}
\location{July 2016 - Nov 2020 \textit{(expected)}} 
...
\runsubsection{Multi Level Cache Simulator}
\descript{\hfill \textit{Aug'19 - Present}}
\projlink{\textit{\href{https://github.com/aniketp/multi-level-cache-simulator}{github.com/aniketp/cache-sim}}}
...
\descript{\hfill \textit{May'18 - Jun'18}}
\location{\textit{Backend Developer Intern \hfill Kanpur, India}}
\begin{itemize}[leftmargin=*, noitemsep]
